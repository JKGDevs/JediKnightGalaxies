...
#define JKG_COPYRIGHT "(C)Jedi Knight Galaxies 2009-2026" //update the current year regularly, 
//due to RC preprocessor macro limitations we can't use something like: #define COPYRIGHT_YEAR (__DATE__ + 7) ;(
